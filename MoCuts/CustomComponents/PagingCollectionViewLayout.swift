...
//            if (nextPage * pageLength) / collectionView.frame.width != nextPage {
//
//                nextPage = (nextPage * pageLength) - ((((nextPage * pageLength) / collectionView.frame.width) - nextPage) * 10)
//                return CGPoint(x: nextPage, y: 0)
//            }
            return CGPoint(x: floor(nextPage * pageLength), y: 0)
        } else {
