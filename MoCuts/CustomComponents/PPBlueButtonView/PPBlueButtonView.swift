...
class PPBlueButtonView: CustomNibView, CAAnimationDelegate {
    ...
    var view: UIView!
    @IBOutlet weak var button: BlueAppButton!
    ...
    //
    //        let colorLeft = UIColor(red: 36.0 / 255.0, green: 94.0 / 255.0, blue: 170.0 / 255.0, alpha: 1.0).cgColor
    //        let colorRight = UIColor(red: 77.0 / 255.0, green: 147.0 / 255.0, blue: 237.0 / 255.0, alpha: 1.0).cgColor
    //
    ...
    private func addAnimatingGradient() {
        ...
        self.bgView.backgroundColor = UIColor.clear
        let gradientTwo = UIColor(red: 35.0/255, green: 85.0/255, blue: 150.0/255, alpha: 1).cgColor
        let gradientOne = UIColor(red: 90.0/255, green: 160.0/255, blue: 245.0/255, alpha: 1).cgColor
