...
protocol MyCardsViewMethod : AnyObject {
    func showReviewPopup()
}

class MyCardsView: BaseView, Routeable {
    ...
    var screenCase : ScreenCase = .wallet
    weak var delegate : MyCardsViewMethod?
...
extension MyCardsView : UITableViewDelegate , UITableViewDataSource {
