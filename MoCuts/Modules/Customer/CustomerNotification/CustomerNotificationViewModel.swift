//
//  CustomerNotificationViewModel.swift
//  MoCuts
//
...
class CustomerNotificationViewModel : BaseViewModel {
    ...
    func getNotifications(offset: Int = 1, showLoader: Bool = true) {
        ...
        customerHomeRepository.getNotifications(offset: offset, successCompletion: { notificationsResponse in
            self.isLoading = false
    ...
    func markRead(notificationId:String) {
        ...
        customerHomeRepository.markNotificationAsRead(notificationId: notificationId, successCompletion: { notificationsResponse in
